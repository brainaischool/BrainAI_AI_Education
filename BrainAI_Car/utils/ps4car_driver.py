"""
BrainAI Car [PS4CarDriver] 모듈_v1.0.0
PS4 컨트롤러로 BrainAI Car를 운전하는 핵심 기능

모듈 위치: / 
모듈 이름: ps4car_driver.py
"""
...
from utils import BrainAICarController, PS4Controller, SPEED_DEFAULT

class PS4CarDriver:
    """PS4 컨트롤러로 자동차를 운전하는 클래스"""
    ...
    def run(self):
        ...
        print('\n✓ 모든 준비 완료!')
        print('컨트롤러로 자동차를 조종하세요!\n')
        
        # 초기 상태 설정
        self.car.set_servo_angle(90)
        time.sleep(0.1)
        self.car.set_motor_speed(0)
        ...
        try:
            while True:
                ...
                # 화면 표시
                cv2.imshow('BrainAI Car - PS4 Drive', frame)
